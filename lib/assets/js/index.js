...
class DiffTable extends React.Component {
    constructor(props) {
        ...
        this.length = Math.max(
            DiffData.baseList.length,
            DiffData.subjectList.length
        );
    }
    ...
    getBaseItems() {
        return this.data.baseList.map((item, i) => {
    ...
    getSubjectItems() {
        return this.data.subjectList.map((item, i) => {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(DiffHeader, {text: 'Base'}),
                ...this.getBaseItems()
            ),
            React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(DiffHeader, {text: 'Subject'}),
